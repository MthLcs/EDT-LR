...
class _EventCardState extends State<EventCard> {
  ...
  Widget build(BuildContext context) {
    DateTime machin = Jiffy(widget.startTime).add(hours : 2);
    DateTime juif = Jiffy(widget.endTime).add(hours : 2);
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text('${Jiffy(machin).format("HH:mm")} - ${Jiffy(juif).format("HH:mm")}  ${widget.summary.split('/')[1]}'), //subtitle: Text(widget.summary.split('/')[1]),
